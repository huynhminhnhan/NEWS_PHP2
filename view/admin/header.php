            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="?atc=home">
								   <i class="fa big-icon fa-home icon-wrap"></i>
								   <span class="mini-click-non">Tin Tức</span>
								</a>
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="quan li tin " href="?atc=qltin"><i class="fa fa-bullseye sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Quản lí tin</span></a></li>
                                <li><a title="quan li danh muc" href="?atc=qldanhmuc"><i class="fa fa-circle-o sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Quản Lý Danh Mục</span></a></li>
                                <li><a title="quan li silde" href="?atc=qlslide"><i class="fa fa-cube sub-icon-mg" aria-hidden="true"></i> <span class="mini-sub-pro">Quản Lí slide</span></a></li>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="header-top-wraper">
                                <div class="row">
                                    ...
                                    <div class="col-lg-11 col-md-12 col-sm-11 col-xs-12">
